...
const CANCELLATION_POLICY_SUMMARY =
  'Bookings are non-refundable. Cancelling removes your spot. Reschedule requests are reviewed by the organizer. If the organizer moves the event, attendees vote in a reschedule poll and the majority decides.';
